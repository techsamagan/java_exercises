...
public class CreatingStreams {
    ...
    public static void main(String[] args) {
        ...
        Arrays.stream(fruits).forEach(name -> System.out.println(name));

        // TODO: 3 - Create a stream using Stream.of() with the values "Red", "Green", "Blue"
        //           and print each element

        Stream.of("Red", "Green", "Blue").forEach(color -> System.out.println(color));
        ...
        Stream<Character> characters = sentence.chars()
                .mapToObj(c -> (char) c);
